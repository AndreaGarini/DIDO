...
class Plant(plantKey: String, plantName: String, plantSpecies: String, idNum: Int, plantCategory: String, plantHumidity: Int, plantWaterInTank: Int, plantIsOutside: Boolean) {
